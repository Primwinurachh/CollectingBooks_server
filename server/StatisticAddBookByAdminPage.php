...
$query = "SELECT DATE_FORMAT(Datetime_Added, '%Y-%m') AS month, COUNT(Book_ID) AS books
            FROM books
            WHERE Datetime_Added BETWEEN '$startMonth-01' AND LAST_DAY('$endMonth-01')
            GROUP BY month
            ORDER BY month";
...
<head>
    ...
    <link rel="stylesheet" href="style/styleStatisticAddBookByAdminPage.css" />
...
<body>
    <?php include('nav.php'); ?>
    <header class="header">
        <p>จำนวนหนังสือที่เพิ่มโดยผู้ดูแลระบบ</p>
    </header>
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: 'จำนวนการเพิ่มหนังสือของผู้ดูแลระบบในแต่ละเดือน',
                        data: data,
                        backgroundColor: 'rgba(54, 162, 235, 0.6)',
                        borderColor: 'rgba(54, 162, 235, 1)',
                        borderWidth: 2, // ความกว้างของเส้นขอบ
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            ...
                            ticks: { // เพิ่มเครื่องหมายจุลภาคตรงนี้
                                font: {
                                    family: 'Anuphan',
                                    size: 12
                                },
